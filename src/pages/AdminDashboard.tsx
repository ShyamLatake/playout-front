...
const AdminDashboard: React.FC = () => {
  ...
  const { user } = useUser();
  const [activeTab, setActiveTab] = useState<'overview' | 'users' | 'turfs' | 'games' | 'bookings' | 'reports' | 'settings'>('overview');
  ...
  if (screenSize === 'mobile') {
    return <AdminMobileView stats={stats} isLoading={isLoading} onRefresh={loadAdminData} />;
  }

  if (screenSize === 'tablet') {
    return <AdminTabletView stats={stats} isLoading={isLoading} onRefresh={loadAdminData} />;
  }

  const getSportIcon = (sport: string) => {
    switch (sport) {
      case 'cricket': return <Activity className="w-4 h-4 text-cricket-600" />;
      case 'football': return <Zap className="w-4 h-4 text-football-600" />;
      case 'tennis': return <Target className="w-4 h-4 text-blue-600" />;
      case 'badminton': return <Dumbbell className="w-4 h-4 text-purple-600" />;
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600">Manage platform operations and monitor activities</p>
            </div>
            ...
            <div className="card">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-primary-600">{stats.totalUsers.toLocaleString()}</p>
                </div>
            ...
            <div className="card">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-turf-600">{stats.totalTurfs}</p>
                </div>
            ...
            <div className="card">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">{stats.totalGames.toLocaleString()}</p>
                </div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="card">
                      ...
                      <div className="space-y-3 max-h-80 overflow-y-auto">
                        {[
                          { type: 'urgent', title: 'Payment Issue', message: 'Failed payment requires attention' },
                          { type: 'high', title: 'User Report', message: 'New harassment report submitted' },
                          { type: 'medium', title: 'Turf Approval', message: '2 turfs pending approval' },
                        ].map((notification, i) => (
                          <div key={i} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                            <div className={`w-2 h-2 rounded-full mt-2 ${
                              notification.type === 'urgent' ? 'bg-red-500' :
                              notification.type === 'high' ? 'bg-orange-500' : 'bg-yellow-500'
                            }`}></div>
                            <div className="flex-1">
                          ...
                          <tr key={i} className="hover:bg-gray-50">
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center gap-3">
                                {getSportIcon('cricket')}
                                <div>
                                  <div className="text-sm font-medium text-gray-900">Cricket Match</div>
                                  <div className="text-sm text-gray-500">Sports Arena {i}</div>
                                </div>
                              </div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-900">Dec 25, 2024</div>
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {[1, 2, 3, 4, 5].map((i) => (
                          <tr key={i} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-900">Sports Arena {i}</div>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                                ...
                                {i % 3 === 0 ? 'Pending' : i % 3 === 1 ? 'Confirmed' : 'Cancelled'}
                              </span>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                              <div className="flex gap-2">
                          ...
                          <div key={i} className="p-4 border border-gray-200 rounded-lg">
                            <div className="flex items-start justify-between mb-2">
                              <div>
                                ...
                                <p className="text-xs text-gray-600">Against: John Doe</p>
                              </div>
                          ...
                          <div key={i} className="p-4 border border-gray-200 rounded-lg">
                            <div className="flex items-start justify-between mb-2">
                              <div>
                                ...
                                <p className="text-xs text-gray-600">Reported by: Mike Johnson</p>
                            ...
                            <p className="text-sm text-gray-700 mb-3">
                              The turf surface was in very poor condition with holes and uneven areas.
                            </p>
                            <div className="flex gap-2">
                              <button className="btn-primary text-xs py-1 px-2">
                                Contact Owner
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="card">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-medium">Turf Approval Required</p>
                            <p className="text-sm text-gray-600">Require admin approval for new turfs</p>
                          </div>
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" className="sr-only peer" defaultChecked />
                            <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
