...
const CreateTurfPage: React.FC = () => {
  ...
  const facilityOptions = [
    {
      ...
      description: "Night time playing capability",
    },
    {
      name: "Scoreboard",
      icon: <Target className="w-4 h-4" />,
      description: "Digital or manual scoreboard",
    },
    {
      name: "Seating Area",
    ...
    },
    {
      ...
      description: "Audio system for announcements",
    },
    {
      name: "First Aid Kit",
    ...
    },
    {
      ...
      description: "Storage for sports equipment",
    },
    {
      name: "Referee Room",
      icon: <Users className="w-4 h-4" />,
      description: "Dedicated referee facilities",
    },
    {
      name: "Commentary Box",
      icon: <Activity className="w-4 h-4" />,
      description: "Commentary facilities",
    },
    {
      name: "CCTV Security",
      icon: <Shield className="w-4 h-4" />,
    ...
    },
    {
      ...
      icon: <Settings className="w-4 h-4" />,
      description: "Regular ground upkeep",
    },
  ];
  ...
  const amenityOptions = [
    ...
    },
    {
      name: "Changing Rooms",
      icon: <Users className="w-4 h-4" />,
      description: "Player changing facilities",
    },
    {
      name: "Washrooms",
      icon: <Users className="w-4 h-4" />,
    ...
    },
    {
      name: "Cafeteria",
      icon: <Activity className="w-4 h-4" />,
      description: "Full dining facility",
    },
    {
      name: "Wi-Fi",
    ...
    },
    {
      ...
      icon: <Activity className="w-4 h-4" />,
      description: "Climate control in indoor areas",
    },
    {
      name: "Lockers",
      icon: <Shield className="w-4 h-4" />,
    ...
    },
    {
      name: "Medical Room",
      icon: <Shield className="w-4 h-4" />,
      description: "Basic medical treatment room",
    },
    {
      name: "24/7 Security",
      icon: <Shield className="w-4 h-4" />,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showSuccess("Turf created successfully!");
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 hidden sm:block">
                  Create your turf listing in {totalSteps} easy steps
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600">
                      Let's start with the essential details about your turf
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-2">
                        This will help customers understand what makes your turf
                        special
                      </p>
                    </div>
                  </div>
              ...
              {currentStep === 2 && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8">
                  ...
                  {errors.sports && (
                    <p className="text-red-500 text-sm mt-4">{errors.sports}</p>
                  )}
                </div>
              )}
              ...
              {currentStep === 3 && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600">
                      Set your pricing and when your turf is available
                    </p>
                  </div>
                  ...
                  <div className="space-y-8">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-2">
                        This is your base hourly rate. You can adjust pricing
                        later.
                      </p>
                    </div>
              ...
              {currentStep === 4 && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600">
                      Select the facilities available at your turf
                    </p>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8">
                    <div className="mb-6">
                      ...
                      <p className="text-gray-600">
                        Select additional amenities that enhance the experience
                      </p>
                    </div>
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          {formData.sports.join(", ") || "None selected"}
                        </p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-gray-700">
